...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    numbers = [DabbssonNumber(dp, device_id, headers) for dp in data if dp["code"] in DPS_METADATA and DPS_METADATA[dp["code"]]["type"] == "value" and DPS_METADATA[dp["code"]].get("writable")]
...
class DabbssonNumber(NumberEntity):
    ...
    def set_native_value(self, value):
        set_device_property(self._device_id, self._headers, self._code, value)
        self._value = value
